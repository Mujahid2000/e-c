          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                {/* Price */}
                <div className="mb-6">
                  <span className="text-5xl font-bold text-accent">${product.price.toFixed(2)}</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card-base">
              ...
              <ul className="space-y-3 text-text-muted">
                ...
                <li className="flex justify-between">
                  <span>Stock:</span>
                  <span className="font-medium text-foreground">{product.inventory} units</span>
                </li>
                <li className="flex justify-between">
            ...
            <div className="card-base">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-text-muted text-sm">{product.reviews} customer reviews</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <Link key={relatedProduct._id} href={`/products/${relatedProduct.slug}`}>
                  <div className="card-base cursor-pointer group">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-xl font-bold text-accent">${relatedProduct.price.toFixed(2)}</span>
                      <div className="flex items-center gap-1">
